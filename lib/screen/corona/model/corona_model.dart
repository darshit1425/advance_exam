...
corona_model corona_modelFromJson(String str) => corona_model.fromJson(json.decode(str));

String corona_modelToJson(corona_model data) => json.encode(data.toJson());
...
class corona_model {
  ...
  factory corona_model.fromJson(Map<String, dynamic> json) => corona_model(
